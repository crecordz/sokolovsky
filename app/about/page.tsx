      ...
      <div className="max-w-7xl mx-auto container-padding py-16">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-serif font-bold mb-8 text-shadow-lg">
            О <span className="gradient-text text-glow">пианисте</span>
          </h1>
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="glass-effect-strong rounded-3xl p-8 text-center card-hover border-glow">
              ...
              <h3 className="text-xl font-semibold mb-4 text-primary-400">Российская академия музыки имени Гнесиных</h3>
              <p className="text-gray-300">Высшее музыкальное образование</p>
            </div>
            <div className="glass-effect-strong rounded-3xl p-8 text-center card-hover border-glow">
              <div className="p-4 bg-primary-500 bg-opacity-20 rounded-full w-16 h-16 mx-auto mb-6 flex items-center justify-center">
                <Award className="text-primary-400" size={32} />
              </div>
              <h3 className="text-xl font-semibold mb-4 text-primary-400">Российский Музыкальный Союз</h3>
              <p className="text-gray-300">Членство в профессиональной организации</p>
            </div>
            <div className="glass-effect-strong rounded-3xl p-8 text-center card-hover border-glow">
              <div className="p-4 bg-primary-500 bg-opacity-20 rounded-full w-16 h-16 mx-auto mb-6 flex items-center justify-center">
                <Music className="text-primary-400" size={32} />
              </div>
              <h3 className="text-xl font-semibold mb-4 text-primary-400">Российское Авторское Общество</h3>
              <p className="text-gray-300">Защита авторских прав композитора</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="glass-effect-strong rounded-3xl p-10 border-glow">
            <div className="grid lg:grid-cols-2 gap-12">
              <div>
                <h3 className="text-2xl font-semibold mb-6 text-primary-400">География выступлений</h3>
              ...
              <div>
                <h3 className="text-2xl font-semibold mb-6 text-primary-400">Классик современности</h3>
