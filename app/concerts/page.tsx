      ...
      <div className="max-w-7xl mx-auto container-padding py-16">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-serif font-bold mb-8 text-shadow-lg">
            <span className="gradient-text text-glow">Проекты</span>
          </h1>
            ...
            {upcomingEvents.map((event, index) => (
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-sm font-medium text-primary-400">{event.type}</span>
                </div>
        ...
        >
          <div className="glass-effect-strong rounded-3xl p-10 border-glow">
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              <div>
                <h3 className="text-2xl font-semibold mb-6 text-white">Организация концертов</h3>
              ...
              <div>
                <h3 className="text-2xl font-semibold mb-6 text-white">Специальные программы</h3>
                <p className="text-gray-300 mb-6 leading-relaxed">
